...
non-secret user-assigned identity client ID; do not create a client secret or grant the workload
management-command permissions. The adx-mon operator, not the workload, owns
table, mapping, retention, batching, and materialized-view commands.
