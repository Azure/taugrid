...
The released controller image, Helm chart, and CRDs are distributed through MCR and are installed by the [TauGrid setup](../../getting-started/taugrid-setup/) flow. This page defines the workspace API and readiness contract; it is not a replacement for installing the cluster control plane.
