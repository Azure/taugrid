...
| Tau | Resolve, validate, render, submit, observe, and preserve workflow evidence |
...
- `portal`: a separate module and binary, `taugrid-portal`. Experiment
  tracking (Stellar) and the observability portal ship there, not in `tau`.
