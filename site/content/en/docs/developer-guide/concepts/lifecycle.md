...
1. **Resolution:** TauGrid finds the project, workspace, and target.
2. **Rendering:** TauGrid validates intent and builds a Job or RayJob.
...
Use the [layered troubleshooting guide](../../../platform-admin-guide/troubleshooting/) to
