...
$typedCommandDependencyFailure = '{"items":[{"metadata":{"name":"adx-mon-typed-metric-events-v1","generation":1},"status":{"conditions":[{"type":"managementcommand.adx-mon.azure.com","observedGeneration":1,"status":"True","message":""}]}},{"metadata":{"name":"adx-mon-typed-metric-events-v1-retention","generation":1},"status":{"conditions":[{"type":"managementcommand.adx-mon.azure.com","observedGeneration":1,"status":"False","message":"Materialized view TauExpMetricEventsV1Dedup was not found"}]}},{"metadata":{"name":"adx-mon-experiment-catalog-v1","generation":1},"status":{"conditions":[{"type":"managementcommand.adx-mon.azure.com","observedGeneration":1,"status":"False","message":"Failed to resolve table expression named TauExpMetricEventsV1"}]}},{"metadata":{"name":"adx-mon-experiment-catalog-v1-retention","generation":1},"status":{"conditions":[{"type":"managementcommand.adx-mon.azure.com","observedGeneration":1,"status":"False","message":"Materialized view TauExpTypedSeriesCatalogV1 does not exist"}]}}]}'
...
Invoke-WaiterCase -Name "typed ManagementCommand dependency retry" -FunctionResponses @($typedFunctionsSuccess, $typedFunctionsSuccess) -ExpectFailure $false -ManagementCommandResponses @($typedCommandDependencyFailure, $typedCommandsSuccess) -LifecycleSchemaResponses @($lifecycleSuccess) -TypedExperimentTelemetryEnabled "true"
