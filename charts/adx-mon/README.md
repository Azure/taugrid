...
> **Image source:** KSM defaults to `mcr.microsoft.com/oss/v2/kubernetes/kube-state-metrics:v2.20.0` — a dalec-built MCR image (MSFT Go, `runAsNonRoot` compatible, active CVE patching). No ACR mirror required.
