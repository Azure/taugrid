...
func TestPortalRayStellarExampleDryRun(t *testing.T) {
	...
	const offloadImage = "registry.example.com/experiment-metrics-collector@sha256:aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"
...
func TestRunConfigKindRayExampleDryRun(t *testing.T) {
	...
	for _, want := range []string{
		...
		"name: tau-kind-ray",
		"namespace: ray",
		"image: mcr.microsoft.com/aks/ai-runtime/ray:py3.12-ray2.58.0-cuda13.0",
		"kueue.x-k8s.io/queue-name: kind-cpu",
		"kueue.x-k8s.io/priority-class: taugrid-default",
		"priorityClassName: taugrid-default",
		"GRPC_DNS_RESOLVER",
