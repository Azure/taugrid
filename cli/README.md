...
| --- | --- |
| Install or upgrade Tau | [Getting started](../site/content/en/docs/platform-admin-guide/kubernetes.md#1-install-the-tau-cli) and [`releases/v0.1.3.md`](releases/v0.1.3.md) |
