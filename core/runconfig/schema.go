...
var fieldCatalog = map[string]FieldInfo{
	...
	"policy.gpu_class":                  {Status: statusSupported, Description: "GPU hardware name matched through KEC's " + workloadmeta.NodeLabelGPUClass + " ResourceFlavor/node selector.", Values: topology.SupportedGPUClasses(), DeprecatedValues: []string{"a10-4gb", "a10-8gb", "a10-12gb", "a10-24gb", "a100-40gb", "a100-80gb", "a100-nvlink-80gb", "h100-80gb", "h100-95gb", "h100-standalone-95gb", "h200-141gb", "h200-nvlink-141gb", "gb200-192gb", "gb300-288gb"}, Notes: "any is unconstrained and renders no class selector. Memory-specific legacy values collapse to KEC's hardware-name granularity; express placement/interconnect with policy.topology."},
