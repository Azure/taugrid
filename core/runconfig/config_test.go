...
metrics:
  ...
  offload:
    enabled: true
    image: mcr.microsoft.com/aks/ai-runtime/experiment-metrics-collector:0.1.0
...
`), "tau.yaml")
	...
	if !cfg.Metrics.Offload.Enabled ||
		...
		cfg.Metrics.Offload.Image != "mcr.microsoft.com/aks/ai-runtime/experiment-metrics-collector:0.1.0" ||
